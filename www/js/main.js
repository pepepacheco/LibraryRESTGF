...
function getReaders() {
    ...
    $.ajax({
        url: "http://35.163.178.255:80/LibraryRESTGF/webresources/entity.reader",
        type: 'GET',
        dataType: 'JSON',
...
function printFormUpdateReader() {
    ...
    $.ajax({
        url: 'http://35.163.178.255:80/LibraryRESTGF/webresources/entity.reader/'+idReader,
        type: 'GET',
        dataType: 'JSON',
        success: function(data) {
            printForm(data);
...
function putReader(reader) {
	...
	$.ajax({
		...
		url: "http://35.163.178.255:80/LibraryRESTGF/webresources/entity.reader/" + reader.id,
		type: "PUT",
		dataType: "JSON",
